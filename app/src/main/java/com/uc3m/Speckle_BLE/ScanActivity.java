...
//import static HR_Profile.SERVICE_HR_UUID;
...
public class ScanActivity extends AppCompatActivity {
    ...
    private static final String RASPBERRY_DEVICE_ADDRESS = "B8:27:EB:64:B9:0C";
    ...
    private final ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            if (!results.isEmpty()) {
                ...
                if (result.getDevice().getAddress().equals(RASPBERRY_DEVICE_ADDRESS)){
                    startInteractActivity(result.getDevice());
                }
                else{
                    Log.i(TAG, "Wrong device. Wanted=" + RASPBERRY_DEVICE_ADDRESS + ", found=" + result.getDevice().getAddress()+ ". Scanning again..." );
                    Toast.makeText(getApplicationContext(), "Wrong device found", Toast.LENGTH_SHORT).show();
                }
            }
        }
    ...
    private void startLeScan() {
        ...
        //filters.add(new ScanFilter.Builder().setServiceUuid(new ParcelUuid(SERVICE_HR_UUID)).build());
        filters.add(new ScanFilter.Builder().setDeviceAddress(RASPBERRY_DEVICE_ADDRESS).build());
